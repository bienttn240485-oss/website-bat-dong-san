...
public sealed class DevelopmentOperationsSeeder(ApplicationDbContext dbContext, ISystemClock clock)
{
        ...
        DateTimeOffset now)
    {
        var rows = new[]
        {
            ...
            new SeedBooking("FB-20260721-001", field7AId, new DateOnly(2026, 7, 21), 1080, 1200, "Lê HoÃ ng Nam", "0903 456 789", "nam@example.local", BookingStatus.Completed, BookingSource.GuestWeb, 840000, [("REFEREE", 1), ("BIB", 1)], "ANPHU50", "Äá»™i khách dùng sân 7 ngÆ°á»i vÃ  thuê trá»ng tÃ i."),
            new SeedBooking("FB-20260721-002", field5AId, new DateOnly(2026, 7, 21), 1200, 1260, "Phạm Anh Khoa", "0904 567 890", "khoa@example.local", BookingStatus.Completed, BookingSource.Owner, 250000, [], null, "Chủ sân tạo hộ khách gá»i điện."),
            new SeedBooking("FB-20260722-001", field5BId, new DateOnly(2026, 7, 22), 1080, 1140, "Võ Minh Äá»©c", "0905 678 901", "duc@example.local", BookingStatus.Completed, BookingSource.GuestWeb, 230000, [("BALL", 1), ("WATER", 1)], null, "Khách đặt sân vÃ  thêm nước uống."),
            new SeedBooking("FB-20260722-002", field7AId, new DateOnly(2026, 7, 22), 1200, 1260, "Äáº·ng ThÃ nh Long", "0906 789 012", "long@example.local", BookingStatus.Completed, BookingSource.Staff, 420000, [("REFEREE", 1)], null, "Thanh toán đủ bằng chuyển khoản."),
            new SeedBooking("FB-20260723-001", field5AId, new DateOnly(2026, 7, 23), 1080, 1140, "Bùi Quang Khải", "0907 890 123", "khai@example.local", BookingStatus.Completed, BookingSource.GuestWeb, 250000, [("BIB", 1)], "ANPHU50", "Ãp dụng khuyến mãi cho khách mới."),
            new SeedBooking("FB-20260723-002", field5BId, new DateOnly(2026, 7, 23), 1140, 1200, "HoÃ ng Gia Bảo", "0908 901 234", "bao@example.local", BookingStatus.Completed, BookingSource.WalkIn, 230000, [], null, "Khách đến trực tiếp trong ngÃ y."),
            new SeedBooking("FB-20260724-001", field7AId, new DateOnly(2026, 7, 24), 1080, 1200, "Ngô Hải ÄÄƒng", "0909 012 345", "dang@example.local", BookingStatus.Completed, BookingSource.GuestWeb, 840000, [("REFEREE", 1), ("WATER", 1)], null, "Ca sân tối thứ sáu đã hoÃ n tất."),
            new SeedBooking("FB-20260724-002", field5AId, new DateOnly(2026, 7, 24), 1260, 1320, "Äá»— Nhật Minh", "0910 123 456", "minh@example.local", BookingStatus.Completed, BookingSource.Staff, 250000, [("BALL", 1)], null, "Khách thanh toán tiá»n mặt."),
            new SeedBooking("FB-20260725-001", field5BId, new DateOnly(2026, 7, 25), 900, 960, "Mai Quốc Việt", "0911 234 567", "viet@example.local", BookingStatus.Completed, BookingSource.GuestWeb, 280000, [("WATER", 1)], "GIOVANG10", "Khung giá» ban ngÃ y cuối tuần."),
            new SeedBooking("FB-20260725-002", field7AId, new DateOnly(2026, 7, 25), 1080, 1200, "Cao Trung Kiên", "0912 345 678", "kien@example.local", BookingStatus.Completed, BookingSource.Owner, 940000, [("REFEREE", 1), ("BIB", 1)], null, "Chủ sân giữ lịch cho giải phong trÃ o."),
            new SeedBooking("FB-20260726-001", field5AId, new DateOnly(2026, 7, 26), 900, 960, "Trịnh Minh Quân", "0913 456 789", "quan@example.local", BookingStatus.PendingPayment, BookingSource.GuestWeb, 300000, [], null, "Khách vừa gửi yêu cầu, chá» ghi nhận cá»c."),
            new SeedBooking("FB-20260726-002", field5BId, new DateOnly(2026, 7, 26), 960, 1020, "Hồ Anh Tuấn", "0914 567 890", "anh.tuan@example.local", BookingStatus.Confirmed, BookingSource.GuestWeb, 280000, [("BALL", 1)], null, "ÄÃ£ nhận cá»c, chá» khách đến sân."),
            ...
            new SeedBooking("FB-20260726-005", field5BId, new DateOnly(2026, 7, 26), 1140, 1200, "Lê Äá»©c Huy", "0917 890 123", "duc.huy@example.local", BookingStatus.Completed, BookingSource.Owner, 280000, [("BIB", 1)], null, "Ca sân trong ngÃ y đã hoÃ n thÃ nh."),
            new SeedBooking("FB-20260726-006", field7AId, new DateOnly(2026, 7, 26), 1200, 1320, "Phan Bảo Long", "0918 901 234", "bao.long@example.local", BookingStatus.Cancelled, BookingSource.GuestWeb, 940000, [], null, "Khách hủy trước giá» đá vì thiếu ngÆ°á»i."),
            new SeedBooking("FB-20260726-007", field5AId, new DateOnly(2026, 7, 26), 1200, 1260, "VÅ© Khánh Linh", "0919 012 345", "linh@example.local", BookingStatus.NoShow, BookingSource.Staff, 300000, [], null, "Khách không đến sau thá»i gian giữ sân."),
            new SeedBooking("FB-20260726-008", field5BId, new DateOnly(2026, 7, 26), 1260, 1320, "Tạ HoÃ ng Phúc", "0920 123 456", "phuc@example.local", BookingStatus.Expired, BookingSource.GuestWeb, 280000, [], null, "Yêu cầu giữ sân hết hạn do chưa thanh toán.")
        };
        ...
        DateTimeOffset timestamp)
    {
        ...
        if (paidAmount > 0)
        {
            booking.RecordPayment(
                ...
                row.Status == BookingStatus.Completed ? "ÄÃ£ thu đủ khi hoÃ n thÃ nh ca sân." : "ÄÃ£ ghi nhận tiá»n cá»c.",
                null,
                timestamp);
        }

...
namespace RealEstateManagement.Web.ViewModels.Bookings;

public sealed class BookingCreateViewModel
{
    [Required(ErrorMessage = "Vui lòng chá»n sân.")]
...
{
    [Required(ErrorMessage = "Vui lòng nhập số tiá»n.")]
    [Range(1, long.MaxValue, ErrorMessage = "Số tiá»n phải lớn hơn 0.")]
    [Display(Name = "Số tiá»n")]
    public long Amount { get; set; }

    [Required(ErrorMessage = "Vui lòng chá»n hình thức thanh toán.")]
...
public sealed class ServiceFormViewModel
{
    ...
    [StringLength(50, ErrorMessage = "ÄÆ¡n vị tính tối đa 50 ký tự.")]
    [Display(Name = "ÄÆ¡n vị tính")]
    public string UnitName { get; set; } = string.Empty;

    [Range(0, long.MaxValue, ErrorMessage = "ÄÆ¡n giá không được âm.")]
    [Display(Name = "ÄÆ¡n giá")]
    public long UnitPrice { get; set; }
...
public sealed class PromotionFormViewModel
{
    ...
    [Range(0, long.MaxValue, ErrorMessage = "ÄÆ¡n tối thiểu không được âm.")]
    [Display(Name = "ÄÆ¡n tối thiểu")]
    public long MinimumOrderAmount { get; set; }

    [Required(ErrorMessage = "Vui lòng nhập thá»i gian bắt đầu.")]
    ...
    [Required(ErrorMessage = "Vui lòng nhập thá»i gian kết thúc.")]
